...
let Person2 = (() => {
    ...
    return _a = class Person2 {
            constructor() {
                this.tasks = __runInitializers(this, _tasks_initializers, [{ name: 'Angel', level: 'hard' }]);
                __runInitializers(this, _tasks_extraInitializers);
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _tasks_decorators = [handlingPerson2];
...
function handlingPerson2(target, context) {
